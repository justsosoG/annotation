...
public class Result {
	...
	private static String SUCCESS_DESC = "操作成功咯";
	
	private static String FAIL_DESC = "操作异常";
	...
	public static  Result fail(Exception e){
		return new Result(false, FAIL_CODE, e.getMessage(),responseTime,FAIL_DESC);
	}
